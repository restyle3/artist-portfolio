...
export default async function Flash({ params }: Props) {
  ...
  return <div>
    <header className="flex items-center justify-between">
      <h1 className="bg-gradient-to-r from-forest-green via-moss-green to-mint-green bg-clip-text text-transparent text-5xl drop-shadow font-extrabold">{flash.name}</h1>
